...
/************************数据库查询*******************************/	
	...
	echo '<form  align="center" bgcolor="#FFCCFF" valign="center" action="userinfor.php?action=del" method="post" onsubmit="return confirm(\'你确定要删除这些图书吗?\')">';
	...
	echo '</tr>';
                            ...
                            echo '<tbody align="center" bgcolor="#FFCCFF" valign="center">';
							  ...
							  echo '<td><a onclick="return confirm(\'你确定要删除《'.$sid.'》这个记录吗？\')" href="userinfor.php?action=del'.$args.'&page='.$page->page.'&id='.$id.'">删除</a></td>';
		echo '</tr>';
	}
	...
	<?php
	echo '<a href="go/界面.html">去可视化页面</a><br>';
