...
if(isset($_POST['dosubmit'])) {
		...
		echo "你好: ".$_SESSION['name']." <a href='stulogout.php'><br>退出</a><br>";
		
	//	$sql = "select tid, username ,password from teauser where username =? and password = ?";
		$sql = "select uid ,name ,password from tb_userinfor where name = ? and password= ?";
		$stmt = $db -> prepare($sql);
